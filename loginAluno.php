      ...
      <div class="div-form hero-text-box">
        <div class="container">
          ...
          <?php 
            ...
            <form method="post"  class="login__form"  action="loginconexaoAluno.php" role="form">
              <p class="login__title">Insira seu Usuário e senha
                ...
                <span class="login__title--grey">
                  <bolder> 1.</bolder> Insira usuario e senha cadastrados</span>
                <br />
                <span class="login__title--grey">            
                          <bolder> 2.</bolder> Caso não seja cadastrado, entre na aba de primeiro acesso</span>
                </span>
                <br/>
                <span class="login__title--grey">            
                          <bolder> 3.</bolder> Em caso de duvidas, entre em contato com a administracao acadêmica atraves da pagina inicial</span>
                </span>
